...
/**
    ...
    @tags{Audio}
*/
class TrimSamplerSound    : public SynthesiserSound
{
public:
    //==============================================================================
    /** Creates a sampled sound from an audio reader.
        ...
        @param maxSampleLengthSeconds   a maximum length of audio to read from the audio
                                        source, in seconds
    */
    TrimSamplerSound (const String& name,
...
/**
    ...
    @tags{Audio}
*/
class TrimSamplerVoice    : public SynthesiserVoice
{
public:
    //==============================================================================
...
private:
    ...
    double sourceEndPosition_ = 0;
    float lgain = 0, rgain = 0;
    Range<double> trimRange_;

    ADSR adsr;

    JUCE_LEAK_DETECTOR (TrimSamplerVoice)
};
